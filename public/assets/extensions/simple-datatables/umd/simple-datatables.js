            ...
            class h {
                ...
                order(t) {
                    ...
                    const r = [
                        ...
                        o = this.dt;
                    t.forEach(((t, a) => {
                        n = o.headings[t], h = "false" !== n.getAttribute("data-sortable"), e = n.cloneNode(!0), e.originalCellIndex = a, e.sortable = h, r[0].push(e), o.hiddenColumns.includes(t) || (s = n.cloneNode(!0), s.originalCellIndex = a, s.sortable = h, r[1].push(s))
                    })), o.data.forEach(((e, s) => {
                ...
                filter(t, e, s, a) {
                    ...
                    i.data = h, this.rebuild(), i.update(), s || i.emit("datatable.sort", t, e)
                }
                sort(t, e, s) {
                    const a = this.dt;
                    ...
                    Promise.all(p).then((n => {
                        ...
                        })), e || (e = c.classList.contains("asc") ? "desc" : "asc"), "desc" == e ? (g = i(l, -1), u = i(r, -1), c.classList.remove("asc"), c.classList.add("desc")) : (g = i(r, 1), u = i(l, 1), c.classList.remove("desc"), c.classList.add("asc")), a.lastTh && c != a.lastTh && (a.lastTh.classList.remove("desc"), a.lastTh.classList.remove("asc")), a.lastTh = c, h = g.concat(u), a.data = [];
                        const f = [];
                        h.forEach(((t, e) => {
                ...
                rebuild() {
                    ...
                    i.activeRows = [], i.activeHeadings = [], i.headings.forEach(((t, e) => {
                        ...
                        t = h.cloneNode(!1), e = h.cloneNode(!1), t.dataIndex = e.dataIndex = l, null !== h.searchIndex && void 0 !== h.searchIndex && (t.searchIndex = e.searchIndex = h.searchIndex), Array.from(h.cells).forEach((n => {
            ...
            class o {
                ...
                render(t) {
                    ...
                    if (s.data && l.call(this), this.body = this.table.tBodies[0], this.head = this.table.tHead, this.foot = this.table.tFoot, this.body || (this.body = e("tbody"), this.table.appendChild(this.body)), this.hasRows = this.body.rows.length > 0, !this.head) {
                        ...
                        this.hasRows && (Array.from(this.body.rows[0].cells).forEach((() => {
                            a.appendChild(e("th"))
                        })), t.appendChild(a)), this.head = t, this.table.insertBefore(this.head, this.body), this.hiddenHeader = s.hiddenHeader
                    }
                ...
                renderPager() {
                    if (s(this.pagers), this.totalPages > 1) {
                        ...
                        this.options.firstLast && s.appendChild(a(t, 1, this.options.firstText)), this.options.nextPrev && s.appendChild(a(t, i, this.options.prevText));
                        let h = this.links;
                        ...
                        })), this.links[this.currentPage - 1].classList.add("active"), this.options.nextPrev && s.appendChild(a(t, n, this.options.nextText)), this.options.firstLast && s.appendChild(a(t, this.totalPages, this.options.lastText)), this.pagers.forEach((t => {
                    ...
                    if ((this.options.scrollY.length || this.options.fixedColumns) && this.activeHeadings && this.activeHeadings.length) {
                        ...
                        if (this.columnWidths = [], this.table.tHead) {
                            if (this.options.scrollY.length && (s = e("thead"), s.appendChild(e("tr")), s.style.height = "0px", this.headerTable && (this.table.tHead = this.headerTable.tHead)), this.activeHeadings.forEach((t => {
                                ...
                                this.table.replaceChild(s, a), this.headerTable.tHead = a, this.headerTable.parentElement.style.paddingRight = `${this.headerTable.clientWidth-this.table.clientWidth+parseInt(this.headerTable.parentElement.style.paddingRight||"0",10)}px`, t.scrollHeight > t.clientHeight && (t.style.overflowY = "scroll")
                            }
                        } else {
                            t = [], s = e("thead");
                            const a = e("tr");
                            ...
                            })), s.appendChild(a), this.table.insertBefore(s, this.body);
                            const i = [];
                            t.forEach(((t, e) => {
                    ...
                    if (o.type) {
                        ...
                        if (a.length) {
                            if ("txt" === o.type || "csv" === o.type) {
                                ...
                                for (l = `INSERT INTO \`${o.tableName}\` (`, n = 0; n < s.length; n++) !o.skipColumn.includes(s[n].originalCellIndex) && this.columns(s[n].originalCellIndex).visible() && (l += `\`${s[n].textContent}\`,`);
                                for (l = l.trim().substring(0, l.length - 1), l += ") VALUES ", n = 0; n < a.length; n++) {
                                    for (l += "(", h = 0; h < a[n].cells.length; h++) !o.skipColumn.includes(s[h].originalCellIndex) && this.columns(s[h].originalCellIndex).visible() && (l += `"${a[n].cells[h].textContent}",`);
                                ...
                                l = JSON.stringify(i, o.replacer, o.space), o.download && (l = `data:application/json;charset=utf-8,${l}`)
                            }
